...
<Library LVVersion="15008000">
	...
	<Item Name="Controls" Type="Folder">
		...
		<Item Name="Inline RT Data Cluster.ctl" Type="VI" URL="../Controls/Inline RT Data Cluster.ctl"/>
		<Item Name="RT Chan Cluster.ctl" Type="VI" URL="../Controls/RT Chan Cluster.ctl"/>
	</Item>
	<Item Name="Real-Time" Type="Folder">
		<Item Name="SubVIs" Type="Folder">
			...
			<Item Name="Read RM Addresses.vi" Type="VI" URL="../Real-Time/SubVIs/Read RM Addresses.vi"/>
			<Item Name="Read RM DMA.vi" Type="VI" URL="../Real-Time/SubVIs/Read RM DMA.vi"/>
			<Item Name="Release shared lock.vi" Type="VI" URL="../Real-Time/SubVIs/Release shared lock.vi"/>
			<Item Name="RT Parse properties.vi" Type="VI" URL="../Real-Time/SubVIs/RT Parse properties.vi"/>
			<Item Name="RT search for decimation channels.vi" Type="VI" URL="../Real-Time/SubVIs/RT search for decimation channels.vi"/>
			<Item Name="RT Subparse properties.vi" Type="VI" URL="../Real-Time/SubVIs/RT Subparse properties.vi"/>
			<Item Name="Write RM Addresses.vi" Type="VI" URL="../Real-Time/SubVIs/Write RM Addresses.vi"/>
			<Item Name="Write RM DMA.vi" Type="VI" URL="../Real-Time/SubVIs/Write RM DMA.vi"/>
		</Item>
